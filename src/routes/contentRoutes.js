...
const LANDING = {
	...
	VENDORS_LIST: lazy(() => import('../pages/Vendors/VendorsList')),
	PRODUCTS_LIST: lazy(() => import('../pages/Products/ProductsList')),
	PURCHASEORDER_LIST: lazy(() => import('../pages/PurchaseOrder/PurchaseOrderList')),
	PURCHASEORDER_RELEASE_LIST: lazy(() => import('../pages/PurchaseOrderRelease/PurchaseOrderReleaseList')),
	PRICING_LIST: lazy(() => import('../pages/Pricing/PricingList')),
	VENDOR_PURCHASE: lazy(() => import('../pages/VendorsPurchaseOrder/VendorsPurchase')),
	VENDOR_RELEASE_ORDER: lazy(() => import('../pages/VendorsReleaseOrder/VendorReleaseOrder')),
...
const presentation = [
	 ...
	 */
	{
		path: dashboardMenu.usersList.path,
		element: <LANDING.USERS_LIST />,
		exact: true,
	},
	{
		path: dashboardMenu.vendorsList.path,
		element: <LANDING.VENDORS_LIST />,
		exact: true,
	},
	{
		path: dashboardMenu.productsList.path,
		element: <LANDING.PRODUCTS_LIST />,
		exact: true,
	},
	{
		path: dashboardMenu.purchaseOrderList.path,
		element: <LANDING.PURCHASEORDER_LIST />,
		exact: true,
	},
	{
		path: dashboardMenu.purchaseOrderReleaseList.path,
		element: <LANDING.PURCHASEORDER_RELEASE_LIST />,
		exact: true,
	},
	{
		path: dashboardMenu.pricingList.path,
		element: <LANDING.PRICING_LIST />,
		exact: true,
	},
	{
		path: `${dashboardMenu.vendorsPurchaseOrdersList.path}/:id`,
		element: <LANDING.VENDOR_PURCHASE />,
		exact: true,
	},
	{
		path: `${dashboardMenu.vendorsReleaseOrdersList.path}/:id`,
		element: <LANDING.VENDOR_RELEASE_ORDER />,
		exact: true,
	},
